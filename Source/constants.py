...
BACKGROUND_SKY_IMAGE = pygame.transform.scale(
    pygame.image.load(r'C:\Users\User\Documents\GitHub\project\Assets\sky.jpeg'), (WIDTH, HEIGHT))
...
LAVA_IMAGE = pygame.transform.scale(
    pygame.image.load(r'C:\Users\User\Documents\GitHub\project\Assets\lava.jpg'), (LAVA_WIDTH, LAVA_HEIGHT))
